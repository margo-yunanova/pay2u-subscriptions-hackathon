...
export const faq = [
  {
    ...
    details:
      'Выберите подписку и подходящий тариф. Для возможности автопродления подписки выберите "Привязать счет" в момент оплаты.',
  },
  {
    title: 'Где можно увидеть оформленные подписки',
    details: 'Оформленная подписка появится в разделе "Мои подписки.',
  },
  {
    title: 'Уже пользуетесь подпиской из нашего списка?',
    details:
      'Если вы уже пользуетесь подпиской из нашего списка, оформите её на новый период в нашем приложении для получения кешбэка.',
  },
  {
    title: 'Зачем мне добавлять сюда мои подписки?',
    details:
      'Заново оформляя свои подписки у нас, вы сможете получать за них кешбэк и управлять всеми подписками в одном месте. Подключайте, меняйте тарифы и отключайте любые подписки в нашем приложении.',
  },
  {
    title: 'Как отключить подписку?',
    details:
      'Подписку можно отключить в разделе "Мои подписки" или на экране самой подписки.',
  },
];
